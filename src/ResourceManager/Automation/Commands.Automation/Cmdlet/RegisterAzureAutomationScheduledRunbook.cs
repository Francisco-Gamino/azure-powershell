...
namespace Microsoft.Azure.Commands.Automation.Cmdlet
{
    ...
    public class RegisterAzureAutomationScheduledRunbook : AzureAutomationBaseCmdlet
    {
        ...
        /// </summary>
        [Parameter(ParameterSetName = AutomationCmdletParameterSets.ByRunbookNameAndScheduleName, Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = "Optional name of the hybrid agent which should execute the runbook")]
        [Alias("HybridWorker")]
