...
New-AzFunctionApp [-ApplicationInsightsKey <String>] [-ApplicationInsightsName <String>]
 [-DisableApplicationInsights] [-DockerImageName <String>] [-Name <String>] [-OSType <Object>] [-PassThru]
 [-PlanName <String>] [-PlanType <String>] [-ResourceGroupName <String>] [-Runtime <String>]
 [-StorageAccountName <String>] [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
New-AzFunctionApp -Name <String> -ResourceGroupName <String> -StorageAccountName <String>
 ...
 [-DockerImageName <String>] [-Location <String>] [-OSType <Object>] [-PassThru] [-PlanType <String>]
 [-Runtime <String>] [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
